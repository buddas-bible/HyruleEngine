...
namespace Hyrule
{
	namespace Physics
	{
		...
		std::shared_ptr<ConvexShape> Shapes::GetShape(const std::string& _name)
		{
			return nullptr;
		}

		std::shared_ptr<ConvexShape> Shapes::CreateConvexShape(const std::string& _name, SHAPE_INPO* _info)
		{
