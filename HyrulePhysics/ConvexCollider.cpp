...
namespace Hyrule
{
    namespace Physics
    {
        ...
        Vector3D ConvexCollider::GetPosition()
        {
            return center * object->GetWorldTM();
        }

        Quaternion ConvexCollider::GetRotation()
        {
            return object->GetRotation();
        }

        Vector3D ConvexCollider::GetScale()
        {
        ...
        float ConvexCollider::GetLength()
        {
            return (GetScale() * 0.5f).Length();
        }

        Matrix4x4 ConvexCollider::GetLocalTM()
        {
            return ToTransformMatrix(center, Quaternion::Identity(), size);
        }

        Matrix4x4 ConvexCollider::GetWorldTM()
        {
            return GetLocalTM() * object->GetWorldTM();
        }

        Vector3D ConvexCollider::GetSize()
        {
            return size;
        }

        Vector3D ConvexCollider::GetCenter()
        {
            return center;
        }
